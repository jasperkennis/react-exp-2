...
Structure based on tips in [Medium article by Jamie Barton](https://medium.com/@notrab/getting-started-with-create-react-app-redux-react-router-redux-thunk-d6a19259f71f).

Should add [these](https://github.com/dwyl/repo-badges).
